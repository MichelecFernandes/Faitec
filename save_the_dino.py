...
def sortearPosicaoMetoro(meteoro, tela):
    ...
    pygame.mixer.Channel(2).play(pygame.mixer.Sound("missil.mp3"))
...
def jogar(tela):
    ...
    pygame.mixer.Channel(0).play(pygame.mixer.Sound("jogosom.mp3"))


    # definições do objeto
    posmeteoro1 = [100, -200, 50, 160]
    posmeteoro2 = [300, -300, 50, 160]
    posmeteoro3 = [450, -500, 50, 160]
    ...
    while continuar:
        ...
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                if event.key == K_LEFT:
                    pygame.mixer.Channel(1).play(pygame.mixer.Sound("aaaaaaa.mp3"))
